...
| W3 (Sprint 4) | **S04 ✅ DONE 정식** + **S06 ✅ DONE 정식 2026-05-26** + **S15-deeplink-schema ✅ 2026-05-26** (migration 0016 + inviteCode helper) + **S12-backend-f1-f4 PARTIAL 2026-05-26** (notify_f1/f2/f3/f4 + `_lib/expo_push` 공통 helper, Deno +42 tests; publishers + RN client 잔여로 S12 IN_PROGRESS 유지). D34(Q-B22 close)·D35 신규 | 5 | Sprint 4 early start. S06 6/6 완성. S15-deeplink schema 진입. S12 backend 4종 완성 (마이크로카피 founder review 대기) |
| W3.5 | — | — | Launch |
