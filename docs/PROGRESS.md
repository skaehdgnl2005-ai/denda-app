...
| **Sprint 4** | W3 | S04 + S06 + S12 + S15 (TestFlight) | **S04 ✅ DONE 2026-05-26** (backend + UI via S05-screen-confirm) / **S06-queue-foundation ✅ + S06-worker-integration ✅ + S06-google-oauth ✅ + S06-migration-0011 ✅ 2026-05-26** (DB schema + pg_cron + 순수 함수 + worker skeleton + Google Calendar 클라이언트 lib + users.calendar_preference 컬럼. Apple expo-calendar · worker stub 교체 · UI 모달은 후속 sub-task) / S12·S15 미시작 | IN_PROGRESS (early start) |
...
| W3 (Sprint 4) | **S04-backend ✅** + **S04-UI ✅ via S05-screen-confirm 2026-05-26** → **S04 ✅ DONE 정식** + **S06-queue-foundation ✅ + S06-worker-integration ✅ + S06-google-oauth ✅ + S06-migration-0011 ✅ 2026-05-26** (DB schema + pg_cron + 순수 함수 + worker skeleton + Google Calendar 클라이언트 lib + users.calendar_preference 컬럼) | 4 | Sprint 4 early start. Q-B5 close by D33. S04 acceptance 5/5 완료. S06 sub-task 4/N 완료 — Apple expo-calendar · worker stub 교체 · UI 모달은 다음 세션 |
| W3.5 | — | — | Launch |
